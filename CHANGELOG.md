...
### v5.2.0-rc.1
- pre-release version 5.2.0-rc.1
...
* feat: add OpenHarmony support for react-native-bottom-sheet
...
- **[#2267](https://github.com/gorhom/react-native-bottom-sheet/issues/2267):** early exit when attempting to snap to index while layout is not ready ([0715f03](https://github.com/gorhom/react-native-bottom-sheet/commit/0715f0384a187cdb1df903d693666ac4b12db807)), closes [#2267](https://github.com/gorhom/react-native-bottom-sheet/issues/2267)
- **[#2278](https://github.com/gorhom/react-native-bottom-sheet/issues/2278):** removed flashlist for web ([e17096f](https://github.com/gorhom/react-native-bottom-sheet/commit/e17096feade145f9e6349815398f8aaae758d554)), closes [#2278](https://github.com/gorhom/react-native-bottom-sheet/issues/2278)
...
- **[#2237](https://github.com/gorhom/react-native-bottom-sheet/issues/2237):** fixed node handle lookup for virtualized list on web (by [@btoo](https://github.com/btoo)) ([6442b0e](https://github.com/gorhom/react-native-bottom-sheet/commit/6442b0ea54a38d8dcb82f63aade077ead29d382b))
- **[#2288](https://github.com/gorhom/react-native-bottom-sheet/discussions/2288):** added unique id to the root bottom sheet modal portal ([711ea7a](https://github.com/gorhom/react-native-bottom-sheet/commit/711ea7a5290ef485b9ba5c65eb45e28d6e495b43)), closes [#2288](https://github.com/gorhom/react-native-bottom-sheet/issues/2288)
...
- **[#2237](https://github.com/gorhom/react-native-bottom-sheet/issues/2237):** fixed recursive loop in findNodeHandle.web (by [@TNAJanssen](https://github.com/TNAJanssen)) ([3556ba8](https://github.com/gorhom/react-native-bottom-sheet/commit/3556ba8e1445a78dfc6cfc93997500d52a03368e))

### Release 5.1.3

#### Bug Fixes

- **[#2237](https://github.com/gorhom/react-native-bottom-sheet/issues/2237):** updated findNodeHandle for web to support React 19 ([47a95f5](https://github.com/gorhom/react-native-bottom-sheet/commit/47a95f517ab5b4680d0f5a45b09464911aafd35e)), closes [#2237](https://github.com/gorhom/react-native-bottom-sheet/issues/2237)

### Release 5.1.2

#### Bug Fixes

- **[#2163](https://github.com/gorhom/react-native-bottom-sheet/issues/2163):** restart closing animation when container height get updated ([4ed9f3c](https://github.com/gorhom/react-native-bottom-sheet/commit/4ed9f3cb542316a984893efa2025ca5384ffe89a)), closes [#2163](https://github.com/gorhom/react-native-bottom-sheet/issues/2163)
- **[#2177](https://github.com/gorhom/react-native-bottom-sheet/issues/2177):** set absolute fill to backdrop default style ([979ba7c](https://github.com/gorhom/react-native-bottom-sheet/commit/979ba7ce0b9d69abfaefd169ee692bf818fa4d0d)), closes [#2177](https://github.com/gorhom/react-native-bottom-sheet/issues/2177)

### Release 5.1.1

#### Bug Fixes

- **[#2043](https://github.com/gorhom/react-native-bottom-sheet/issues/2043):** handle unnecessary invocation of index side effect ([#2073](https://github.com/gorhom/react-native-bottom-sheet/issues/2073))(inspired by [@IslamRustamov](https://github.com/IslamRustamov)) ([2164c02](https://github.com/gorhom/react-native-bottom-sheet/commit/2164c02e63177f9ac69acc05722c85e8d55cd931)), closes [#2043](https://github.com/gorhom/react-native-bottom-sheet/issues/2043)

### Release 5.1.0

#### Bug Fixes

- **[#2129](https://github.com/gorhom/react-native-bottom-sheet/issues/2129):** fixed initial isAnimatedOnMount value ([0850cb8](https://github.com/gorhom/react-native-bottom-sheet/commit/0850cb864819f79189592cb66c2b6d179957ba61))
...
- **[#1983](https://github.com/gorhom/react-native-bottom-sheet/issues/1983):** updated shared values access as hook dependancies ([#1992](https://github.com/gorhom/react-native-bottom-sheet/issues/1992))(by [@pinpong](https://github.com/pinpong)) ([9757bd2](https://github.com/gorhom/react-native-bottom-sheet/commit/9757bd251cba67cf26489640f20fd1557b1a426e)), closes [#1983](https://github.com/gorhom/react-native-bottom-sheet/issues/1983) [#1983](https://github.com/gorhom/react-native-bottom-sheet/issues/1983)
- added BottomSheetFlashList mock ([#1988](https://github.com/gorhom/react-native-bottom-sheet/issues/1988))(by [@Fadikk367](https://github.com/Fadikk367)) ([13c7d47](https://github.com/gorhom/react-native-bottom-sheet/commit/13c7d47beae6f2451968d30e862f0ea49b7199b6))

### Release 5.0.4

#### Bug Fixes

- **[#1983](https://github.com/gorhom/react-native-bottom-sheet/issues/1983):** updated shared values access as hook dependancies ([ae41b2d](https://github.com/gorhom/react-native-bottom-sheet/commit/ae41b2da650d2be614d840fbdfe1d29db6d7a575)), closes [#1983](https://github.com/gorhom/react-native-bottom-sheet/issues/1983)
- **[#1987](https://github.com/gorhom/react-native-bottom-sheet/issues/1987):** updated provided style handling for bottom sheet view ([4c8ae25](https://github.com/gorhom/react-native-bottom-sheet/commit/4c8ae252b8ec0bb420b60f8314cc7f04ed12b519)), closes [#1987](https://github.com/gorhom/react-native-bottom-sheet/issues/1987)

### Release 5.0.3

#### Bug Fixes

- added children type to containerComponent prop type ([#1971](https://github.com/gorhom/react-native-bottom-sheet/issues/1971))(by [@Nodonisko](https://github.com/Nodonisko)) ([203e52f](https://github.com/gorhom/react-native-bottom-sheet/commit/203e52fa5be3e167522776f184d79511bdf35344))
...
[Read the full announcement](https://gorhom.dev/react-native-bottom-sheet/blog/bottom-sheet-v5) 🚀

#### Features

- added web support ([#1150](https://github.com/gorhom/react-native-bottom-sheet/pull/1150)) ([`a996b4a`](https://github.com/gorhom/react-native-bottom-sheet/commit/a996b4aa68139136ec75e0921025d235471c838d))
...
- rewrite gesture apis with gesture handler 2 ([#1126](https://github.com/gorhom/react-native-bottom-sheet/pull/1126)) ([`6a4d296`](https://github.com/gorhom/react-native-bottom-sheet/commit/6a4d2967684b01e28f23b1b35afbb4cc4dabaf1d))
- added accessibility overrides support ([#1288](https://github.com/gorhom/react-native-bottom-sheet/issues/1288))(by [@Mahmoud-SK](https://github.com/Mahmoud-SK)) ([6203c18](https://github.com/gorhom/react-native-bottom-sheet/commit/6203c18acc9f8dc3a31af5bf5ad80e368deceb52))
- added default dynamic sizing ([#1513](https://github.com/gorhom/react-native-bottom-sheet/issues/1513))(with [@Eli-Nathan](https://github.com/Eli-Nathan) & [@ororsatti](https://github.com/ororsatti)) ([#1683](https://github.com/gorhom/react-native-bottom-sheet/issues/1683)) ([8017fb6](https://github.com/gorhom/react-native-bottom-sheet/commit/8017fb6b02088d3c66c64a8a23e0f63f22884d36))
...
- replace getRefNativeTag with findNodeHandle ([#1823](https://github.com/gorhom/react-native-bottom-sheet/issues/1823))(by [@AndreiCalazans](https://github.com/AndreiCalazans)) ([866b4ee](https://github.com/gorhom/react-native-bottom-sheet/commit/866b4ee570fc345d59053561c26af67144e8fd6f))
- **BottomSheetContainer:** cannot add new property 'value' ([#1808](https://github.com/gorhom/react-native-bottom-sheet/issues/1808))(by [@MoritzCooks](https://github.com/MoritzCooks)) ([ccd6bb5](https://github.com/gorhom/react-native-bottom-sheet/commit/ccd6bb540884f35fb9c0dcd5527ed8bac0c1be91))
...
- (BottomSheetTextInput): reset shouldHandleKeyboardEvents on unmount ([#1495](https://github.com/gorhom/react-native-bottom-sheet/pull/1495))(by [@koplyarov](https://github.com/koplyarov)) ([`81cd66f`](https://github.com/gorhom/react-native-bottom-sheet/commit/81cd66f9c49843e43231d1d81ec4aa518a9f1b95))
- updated containerOffset top value to default to 0 ([#1420](https://github.com/gorhom/react-native-bottom-sheet/pull/1420))(by [@beqramo](https://github.com/beqramo)) ([`b81cb93`](https://github.com/gorhom/react-native-bottom-sheet/commit/b81cb9368b55c24703a9c000a76e89a2d253e141))
- resume close animation when container gets resized ([#1374](https://github.com/gorhom/react-native-bottom-sheet/issues/1374)) ([#1392](https://github.com/gorhom/react-native-bottom-sheet/pull/1392)) ([`1f69625`](https://github.com/gorhom/react-native-bottom-sheet/commit/1f69625e180fcec4d8d3dec436f8d5bb4eba476b))
- (bottom-sheet-modal): added container component prop to modal ([#1309](https://github.com/gorhom/react-native-bottom-sheet/pull/1309))(by [@magrinj](https://github.com/magrinj)) ([`67e1e09`](https://github.com/gorhom/react-native-bottom-sheet/commit/67e1e09acbc0e96e435a0c2247fa1e0bc19f91aa))
- updated scrollables mocks with ReactNative list equivalent ([#1394](https://github.com/gorhom/react-native-bottom-sheet/pull/1394))(by [@gkueny](https://github.com/gkueny)) ([`630f87f`](https://github.com/gorhom/react-native-bottom-sheet/commit/630f87ff6bd19c4dfc071783139c938eda3baf6c))
- crash on swipe down ([#1367](https://github.com/gorhom/react-native-bottom-sheet/pull/1367))(by [@beqramo](https://github.com/beqramo)) ([`3ccbefc`](https://github.com/gorhom/react-native-bottom-sheet/commit/3ccbefc4d16558867d518f7e0306fbb4d1dbdbeb))
- (BottomSheetScrollView): updated scroll responders props type ([#1335](https://github.com/gorhom/react-native-bottom-sheet/pull/1335))(by [@eps1lon](https://github.com/eps1lon)) ([`e42fafc`](https://github.com/gorhom/react-native-bottom-sheet/commit/e42fafcc492d01665c296bf551a6a264eb866fc5))
- fixed keyboard dismissing issue with Reanimated v3 ([#1346](https://github.com/gorhom/react-native-bottom-sheet/pull/1346))(by [@janicduplessis](https://github.com/janicduplessis)) ([`1d1a464`](https://github.com/gorhom/react-native-bottom-sheet/commit/1d1a46489bede1d3f119df2fb6f467e778461c39))

- ([#1119](https://github.com/gorhom/react-native-bottom-sheet/issues/1119)): fixed race condition between onmount and keyboard animations ([`a1ec74d`](https://github.com/gorhom/react-native-bottom-sheet/commit/a1ec74dbbc85476bb39f3637e9a97214e0cad9a0))

#### Chores And Housekeeping

- updated expo and react native deps ([#1445](https://github.com/gorhom/react-native-bottom-sheet/pull/1445)) ([`f6f2304`](https://github.com/gorhom/react-native-bottom-sheet/commit/f6f2304235c05f92d86ce8083caf910b9297a10a))
- updated react native and other deps ([#1412](https://github.com/gorhom/react-native-bottom-sheet/pull/1412)) ([`549e461`](https://github.com/gorhom/react-native-bottom-sheet/commit/549e461530a91e1d7c95a5178bd2238ebf84df86))
- fixed types ([#1123](https://github.com/gorhom/react-native-bottom-sheet/pull/1123))(by [@stropho](https://github.com/stropho)) ([`b440964`](https://github.com/gorhom/react-native-bottom-sheet/commit/b44096451d4fed81be7f08b0edf638e4a1c42ccd))
- updated reanimated to v3 ([#1324](https://github.com/gorhom/react-native-bottom-sheet/pull/1324)) ([`4829316`](https://github.com/gorhom/react-native-bottom-sheet/commit/4829316beeff95c9e2efa5fbfdfcf7ef37b4af60))
...
- replace getRefNativeTag with findNodeHandle ([#1823](https://github.com/gorhom/react-native-bottom-sheet/issues/1823))(by [@AndreiCalazans](https://github.com/AndreiCalazans)) ([b906f5e](https://github.com/gorhom/react-native-bottom-sheet/commit/b906f5e67afdb823b7c31a9a929e757fc35222a2))